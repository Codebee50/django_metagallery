...
from product.models import Nft
...
class VerifyNftView(generics.GenericAPIView):
    def post(self, request, *args, **kwargs):
        ...
        send_raw_email(nft.owner.email, "Nft verified", f"Hurrayy!! {nft.owner.username} Your nft was approved and is now listed")
...
class DeclineNftView(generics.GenericAPIView):
    def post(self, request, *args, **kwargs):
        ...
        send_raw_email(nft.owner.email, "Nft declined", f"Hello {nft.owner.username} Your nft was declined by the admin")
...
class DeclineWithdrawalView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        withdrawal.save()
        send_raw_email(withdrawal.wallet.user.email, "Withdrawal declined", f"Hello {withdrawal.wallet.user.username} Your withdrawal request has been declined")

        return SuccessResponse(message="Withdrawal declined successfully")
...
class VerifyWithdrawalView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        send_raw_email(withdrawal.wallet.user.email, "Withdrawal verified", f"Hello {withdrawal.wallet.user.username} Your withdrawal has been processed successfully")
        return SuccessResponse(message="Withdrawal verified successfully")
...
class DeclineDepositView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        send_raw_email(deposit.wallet.user.email, "Deposit declined", f"Hello {deposit.wallet.user.username} Your deposit request has been declined")
...
class VerifyDepositEndpoint(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        send_raw_email(deposit.wallet.user.email, "Deposit verified", f"Hello {deposit.wallet.user.username} Your Deposit has been processed successfully")
